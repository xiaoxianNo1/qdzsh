        ...
        <form class="am-form am-margin-top-xs">
            <div class="am-input-group am-input-group-sm">
                ...
                <span class="am-input-group-btn search-r">
						<button class="am-btn am-btn-default search-r-btn" type="button"><span class="am-icon-pencil-square-o"></span><a href="<%=path%>/message/askquestion" target="_blank">提问</a></button>
				</span>
            </div>
        </form>
    </div>
